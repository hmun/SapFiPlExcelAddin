...
Partial Public NotInheritable Class SapFiPlExcelAddin
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapFiPlExcelAddin As SapFiPlExcelAddin
    ...
    Friend Shared Property SapFiPlExcelAddin() As SapFiPlExcelAddin
        Get
            Return _SapFiPlExcelAddin
        End Get
        Set
            If (_SapFiPlExcelAddin Is Nothing) Then
                _SapFiPlExcelAddin = value
            Else
